...
Add the page button to the References.qml in Gui/Glo0bals
...
Change the continueButton.onClicked signal/slot of the previous/new page in layout.qml to ensure the new/next page can be navigated to.